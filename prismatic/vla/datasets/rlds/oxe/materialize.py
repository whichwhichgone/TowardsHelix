...
def make_oxe_dataset_kwargs(
    ...
    if dataset_kwargs["action_encoding"] not in [ActionEncoding.EEF_POS, ActionEncoding.EEF_R6, ActionEncoding.JOINT_POS_PIPER_SINGLE]:
    ...
    elif dataset_kwargs["action_encoding"] is ActionEncoding.JOINT_POS_PIPER_SINGLE:
